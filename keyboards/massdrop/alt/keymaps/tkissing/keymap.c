...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_LAYER_BASE] = LAYOUT_65_ansi_blocker(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,          LT(_LAYER_FN, KC_SPC),                                KC_RALT, TT(_LAYER_FN),    KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
    [_LAYER_FN] = LAYOUT_65_ansi_blocker(
        KC_GRV,  KC_F1,     KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______, KC_END,  \
        _______, _______,   KC_UP, _______, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, KC_HOME, \
        _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, _______, _______, _______, _______,          _______, KC_PGUP, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, KC_PGDN, \
        _______, _______, _______,          _______,                                       MO(_LAYER_RGB), _______,          _______, _______, _______  \
    ),
    [_LAYER_RGB] = LAYOUT_65_ansi_blocker(
